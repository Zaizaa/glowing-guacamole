...
<main id="main">
  ...
  <section class="breadcrumbs">
      <div class="container">  
          <img src="https://www.pinclipart.com/picdir/big/24-242586_bmw-logo-png-transparent-amp-svg-vector-bmw.png" alt="" width="100">
          <div style="display: inline-block; vertical-align: middle;">
              <h1 style="display: inline;">&nbsp;BMW</h1>
          </div>
      </div>
          ...
          <div class="col-lg-3">
              <div class="sidebar">
                  ...
                  <div class="sidebar-item categories">
                      <ul class="hanaa">
                      <li><a href="BMW.php"><i class="bi bi-chevron-right"></i>Tout <span>(25)</span></a></li>
                          <li><a href="BMW1.php"><i class="bi bi-chevron-right"></i>Serie 1 <span>(12)</span></a></li>
                          <li><a href="BMW2.php"><i class="bi bi-chevron-right"></i>Serie 2 <span>(5)</span></a></li>
                          <li><a href="BMW3.php"><i class="bi bi-chevron-right"></i>Serie 3 <span>(5)</span></a></li>   
                          <li><a href="BMW4.php"><i class="bi bi-chevron-right"></i>Serie 4 <span>(8)</span></a></li>
                      </ul>
...
<!--les 3 premiers blocs-->
          ...
          <?php
                              $connection = mysqli_connect("localhost:3307","root","","utilisateurs");
                               $query = "SELECT * FROM voiture WHERE id_marque = 2 AND Quantite >0 AND Modele='SERIE 1'";
