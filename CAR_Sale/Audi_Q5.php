    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="index.php#about">Login <i class="bi bi-person"></i></a></li>
        </ul>
...
<main id="main">
  ...
  <section class="breadcrumbs">
      <div class="container">  
          <img src="assets/img/audi2.png" alt="" width="100">
          <div style="display: inline-block; vertical-align: middle;">
              <h1 style="display: inline;">&nbsp;Audi</h1>
          </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
              <div class="sidebar">
                  ...
                  <div class="sidebar-item categories">
                      <ul class="hanaa">
                          <li><a href="Audi.php"><i class="bi bi-chevron-right"></i>Tout <span>(25)</span></a></li>
                          <li><a href="Audi_A3.php"><i class="bi bi-chevron-right"></i>Audi A3 <span>(12)</span></a></li>
                          <li><a href="Audi_Q3.php"><i class="bi bi-chevron-right"></i>Audi Q3 <span>(5)</span></a></li>
                          <li><a href="Audi_Q5.php"><i class="bi bi-chevron-right"></i>Audi Q5 <span>(5)</span></a></li>                         
                          <li><a href="Audi_Q8.php"><i class="bi bi-chevron-right"></i>Audi Q8 <span>(8)</span></a></li>              
                      </ul>
                  </div>
              </div>
          </div>
          <?php
                              $connection = mysqli_connect("localhost:3307","root","","utilisateurs");
                               $query = "SELECT * FROM voiture WHERE id_marque = 3 AND Quantite >0 AND Modele='AUDI Q5'";
